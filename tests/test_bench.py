...
def test_benchmark_report_shape():
    ...
    assert set(report["methods"]) == {"AgenticRec-Gated", "AgenticRec-Collab", "AgenticRec-Core", "HotBaseline", "TagBaseline"}
    metrics = report["methods"]["AgenticRec-Gated"]["summary"]["overall"]
